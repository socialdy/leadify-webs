...
interface SalzburgCityPageProps {
  posts: Post[];
}
...
export default function SalzburgPage({ posts }: SalzburgCityPageProps) {
  ...
  const dynamicCitiesWords = [
    "Hallein", "Saalfelden am Steinernen Meer", "Zell am See", "Bischofshofen",
  ];
