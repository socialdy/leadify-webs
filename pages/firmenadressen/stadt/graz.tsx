...
const seo = {
  title: `Firmenadressen kaufen Graz | B2B Leads - Leadify.at`,
  description: `Firmenadressen in Graz kaufen: Präzise B2B Leads mit Telefon, E-Mail & Ansprechpartnern. DSGVO-konform, sofortiger Download in Excel/CSV. Ideal für Marketing & Vertrieb in Graz.`,
  ogTitle: `Firmenadressen kaufen aus Graz | B2B Adressen aus Graz kaufen`,
  ogDescription: `Firmenadressen mit unlimitierter Nutzung günstig kaufen aus Graz. Starte die Suche für Graz Adressen. Kostenloses Angebot &amp; sofortiger Excel &amp; CSV Download`,
...
export default function GrazPage({ posts }: GrazPageProps) {
  ...
  const dynamicCitiesWords = [
    "Leoben", "Kapfenberg", "Bruck an der Mur", "Deutschlandsberg",
  ];
